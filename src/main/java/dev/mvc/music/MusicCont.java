...
public class MusicCont {
  ...
  /**
   * 생성 ::
   * http://localhost:9090/team1/music/create.do
   * @return
   */
...
//    }
  ...
  /**
   * 가수번호에 따른 조회 ::
   * http://localhost:9090/team1/music/list_by_singerno.do
   * @param singerno
   * @return
   */
...
//            }    
  ...
  public ModelAndView list_by_genreno_search_paging(
      @RequestParam(value="genreno", defaultValue="1") int genreno, // 기본값 지정(값 못받을 시 대비)
...
//  } <!-- 참고 소스 --!>
  ...
  /**
   * 결합된 장르 별 음악 목록
   * http://localhost:9090/team1/music/list_index_left.do
   * @param request
   * @return
   */
