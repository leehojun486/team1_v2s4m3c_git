...
public class GenreCont {
  ...
  /**
   * ����� http://localhost:9090/team1/genre/create.do
   * 
   * @return
   */
  ...
  /**
   * ��� http://localhost:9090/team1/genre/list.do
   * 
   * @return
   */
  ...
  /**
   * ��ȸ + ������ http://localhost:9090/team1/genre/read_update.do
   * 
   * @return
   */
  ...
  /**
   * ������ http://localhost:9090/resort/genre/read_delete.do
   * @return
   */
