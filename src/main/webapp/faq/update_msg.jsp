...
<DIV class='message'>
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <c:choose>
        <c:when test="${cnt ==1 && pass_cnt ==1 }">
          <LI class='li_none'>
            <button type='button' 
                        onclick="location.href='./read.do?faqno=${param.faqno}&nowPage=${param.nowPage }'"
                        class="btn btn-info">변경 확인</button>
            <button type='button' 
                        onclick="location.href='./list.do?faqno=${param.faqno}&nowPage=${param.nowPage }'"
