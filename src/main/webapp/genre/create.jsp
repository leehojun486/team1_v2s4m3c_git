...
<DIV class='title_line'>장르 등록</DIV>
 
<FORM name='frm' method='POST' action='./create.do' class="form-horizontal">
 <input type="hidden" name="homeno" value="1">
 ...
 <div class="form-group">
    ...
    <div class="form-group">
     ...
     <div class="col-md-9">
        <select name='genrename' class="form-control" style='width: 30%;'>
          <option value='hiphop' selected="selected">hiphop</option>
