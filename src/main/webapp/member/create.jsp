...
<script type="text/javascript">
  ...
  function checkID() {
    ...
    var memberid = $('#memberid', frm).val(); // frm 폼에서 id가 'id'인 태그 검색
    var params = '';
    var msg = '';
      ...
      $.ajax({
        ...
        success: function(rdata) { // 서버로부터 성공적으로 응답이 온경우
          ...
          if (rdata.cnt > 0) {
            $('#modal_content').attr('class', 'alert alert-danger'); // Bootstrap CSS 변경
            msg = "이미 사용중인 ID 입니다.";
            $('#btn_close').attr("data-focus", "memberid");
          } else {
            $('#modal_content').attr('class', 'alert alert-success'); // Bootstrap CSS 변경
            msg = "사용 가능한 ID 입니다.";
            $('#btn_close').attr("data-focus", "memberpass");
...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <FORM name='frm' id='frm' method='POST' action='./create.do' class="form-horizontal"enctype="multipart/form-data">>
    ...
    <div class="form-group">
      <label for="memberid" class="col-md-2 control-label" style='font-size: 0.9em;'>아이디*</label>    
      <div class="col-md-10">
        ...
        <SPAN memberid='memberid_span'></SPAN> <!-- ID 중복 관련 메시지 -->        
      </div>
    </div>   
                
    <div class="form-group">
      <label for="memberpass" class="col-md-2 control-label" style='font-size: 0.9em;'>패스워드*</label>    
      <div class="col-md-10">
        <input type='password' class="form-control" name='memberpass' id='memberpass' value='' required="required" style='width: 30%;' placeholder="패스워드">
      </div>
    </div>   

    <div class="form-group">
      <label for="memberpass2" class="col-md-2 control-label" style='font-size: 0.9em;'>패스워드 확인*</label>    
      <div class="col-md-10">
        <input type='password' class="form-control" name='memberpass2' id='memberpass2' value='' required="required" style='width: 30%;' placeholder="패스워드">
      </div>
    </div>   
    
    <div class="form-group">
      <label for="membername" class="col-md-2 control-label" style='font-size: 0.9em;'>성명*</label>    
      <div class="col-md-10">
    ...
    <div class="form-group">
      <label for="memberzip" class="col-md-2 control-label" style='font-size: 0.9em;'>우편번호</label>    
      <div class="col-md-10">
        <input type='text' class="form-control" name='memberzip' id='memberzip' 
    ...
    <div class="form-group">
      <label for="memberadd2" class="col-md-2 control-label" style='font-size: 0.9em;'>상세 주소</label>    
      <div class="col-md-10">
        <input type='text' class="form-control" name='memberadd2' id='memberadd2' 
      ...
      <div class="form-group">   
        <div class="col-md-12">
          ...
          <input type='file' class="form-control" name='memberimgMF' id='memberimgMF' 
    ...
    function DaumPostcode() {
        ...
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                $('#memberzip').val(data.zonecode); //5자리 새우편번호 사용 ★
                $('#memberadd1').val(fullAddr);  // 주소 ★
