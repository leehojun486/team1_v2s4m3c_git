  ...
  <FORM name='frm' id='frm' method='POST' action='./update.do' 
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
       ...
       <div class="form-group">
      <label class="col-md-2 control-label" style='font-size: 0.9em;'>닉네임</label>    
      <div class="col-md-10">
        <input type='text' class="form-control" name='membernicname' id='membernicname' 
                   value='${memberVO.membernicname }' required="required" style='width: 30%;' placeholder="닉네임">
      </div>
    </div>   
 
    <div class="form-group">
      <label class="col-md-2 control-label" style='font-size: 0.9em;'>E-Mail</label>    
      <div class="col-md-10">
        <input type='text' class="form-control" name='membereml' id='membereml' 
                   value='${memberVO.membereml }' required="required" style='width: 30%;' placeholder="이메일"> 
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='memberzip' id='memberzip' 
                   value='${memberVO.memberzip }' required="required" style='width: 30%;' placeholder="우편번호">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='memberadd1' id='memberadd1' 
                   value='${memberVO.memberadd1 }' required="required" style='width: 80%;' placeholder="주소">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='memberadd2' id='memberadd2' 
                   value='${memberVO.memberadd2 }' required="required" style='width: 80%;' placeholder="상세 주소">
      </div>
    </div>   
