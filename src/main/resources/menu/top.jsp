...
<DIV class='container' style='width: 100%;'> 
  ...
  <DIV class='top_img'>
    ...
    <NAV class='top_menu'>
      ...
      <A class='top_menu_link'  href='${pageContext.request.contextPath}' >음악</A> <span class='top_menu1'> | </span>
      ...
      <c:choose>
        ...
        <c:otherwise>
          ${sessionScope.memberid } <A class='top_menu_link'  href='${pageContext.request.contextPath}/member/logout.do' >Logout</A><span class='top_menu_sep'>&nbsp;</span>
        </c:otherwise>
      </c:choose>    
      [
          <A class='top_menu_link'  href='${pageContext.request.contextPath}/faq/list_all.do'>FAQ</A><span class='top_menu_sep'>&nbsp;</span>       
      <c:choose>
        <c:when test="${sessionScope.adminid == null}">
          <A class='top_menu_link'  href='${pageContext.request.contextPath}/admin/login.do' >관리자 Login</A>
        </c:when>
        <c:otherwise>
          ${sessionScope.adminid } <A class='top_menu_link'  href='${pageContext.request.contextPath}/admin/logout.do' >관리자 Logout</A><span class='top_menu_sep'>&nbsp;</span> 
          <A class='top_menu_link'  href='${pageContext.request.contextPath}/admin/create.do'>관리자 등록</A> <span class='top_menu1'> | </span> 
